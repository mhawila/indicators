module.exports = (function(){
    ...
    var eClient = require('./elastic.client.js');
    ...
    function getEnrolledInCare(params, callback, eCallback) {
        ...
        eClient.search(query).then(function(data) {
            var count = data.aggregations.enrolled.patients.buckets.length;
    ...
    function getEnrolledInCareMOh(params, callback) {
        ...
        var below1;
        eClient.search(query).then(function(data) {
            below1 = data.aggregations.enrolled.patients.buckets.length;
            //Below 15 years Male
            ...
            var below15Male;
            eClient.search(query).then(function(data) {
                below15Male = data.aggregations.enrolled.patients.buckets.length;
                ...
                console.log('getEnrolledInCareMOh: below 15 (female) query: ', 
                                JSON.stringify(query));
                eClient.search(query).then(function(data) {
                    var below15Female = data.aggregations.enrolled.patients.buckets.length;
                    ...
                    eClient.search(query).then(function(data) {
                        var above15Male = data.aggregations.enrolled.patients.buckets.length;
                        ...
                        eClient.search(query).then(function(data) {
                            var above15Female = data.aggregations.enrolled.patients.buckets.length;
